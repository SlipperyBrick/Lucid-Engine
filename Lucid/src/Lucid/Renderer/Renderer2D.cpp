...
struct Renderer2DData
{
	...
	// Could implement RenderCapabilities to fetch this for us
	...
	// A value of 0 equates to a white texture
...
void Renderer2D::Init()
{
	...
	s_Data.TextureShader = Shader::Create("assets/shaders/Quad.glsl");
